    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-neutral-50 px-4">
        <div className="max-w-md w-full bg-white rounded-xl shadow-sm border border-neutral-200 p-8 text-center">
          ...
          <h1 className="text-xl font-bold text-neutral-900 mb-2">Invalid Activation Link</h1>
          <p className="text-neutral-500 text-sm mb-6">
            This link is invalid or has already been used. Please ask your administrator to resend
            the invitation.
          </p>
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-neutral-50 px-4">
        <div className="max-w-md w-full bg-white rounded-xl shadow-sm border border-neutral-200 p-8 text-center">
          ...
          <h1 className="text-xl font-bold text-neutral-900 mb-2">Account Already Active</h1>
          <p className="text-neutral-500 text-sm mb-6">
            Your account has already been activated. Please log in with your email and password.
          </p>
          <Link
            to="/login"
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-neutral-50 px-4">
        <div className="max-w-md w-full bg-white rounded-xl shadow-sm border border-neutral-200 p-8 text-center">
          ...
          <h1 className="text-xl font-bold text-neutral-900 mb-2">Account Activated!</h1>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-neutral-50 px-4">
      <div className="max-w-md w-full bg-white rounded-xl shadow-sm border border-neutral-200 p-8">
        ...
        {/* User info card */}
        {userInfo && (
          <div className="bg-neutral-50 rounded-xl p-4 border border-neutral-100 flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-neutral-700">{userInfo.email}</p>
            </div>
          </div>
        )}
        ...
        <form onSubmit={handleActivate} className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-2.5 border border-neutral-300 rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-transparent outline-none transition-shadow pr-16"
                placeholder="••••••••"
              />
              <button
                type="button"
                onClick={() => setShowPassword(!showPassword)}
                className="absolute inset-y-0 right-0 pr-3 flex items-center text-sm text-neutral-500 hover:text-neutral-700"
              >
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className={`w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-transparent outline-none transition-shadow pr-16 ${
          ...
          <div className="bg-neutral-50 rounded-lg p-4 text-sm border border-neutral-100">
            ...
            <ul className="space-y-1">
              <li className={`flex items-center gap-2 ${hasLength ? 'text-green-600' : 'text-neutral-400'}`}>
                <span>{hasLength ? '✓' : '○'}</span> Minimum 8 characters
              </li>
              <li className={`flex items-center gap-2 ${hasSymbol ? 'text-green-600' : 'text-neutral-400'}`}>
                <span>{hasSymbol ? '✓' : '○'}</span> At least one number or symbol
              </li>
            </ul>
          </div>
          ...
          <button
            ...
            className="w-full bg-blue-600 hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed text-white font-medium py-2.5 rounded-lg transition-colors mt-2 flex items-center justify-center gap-2"
          >
            {isSubmitting ? (
              <>
